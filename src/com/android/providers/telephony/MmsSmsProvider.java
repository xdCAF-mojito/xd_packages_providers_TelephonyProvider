...
public class MmsSmsProvider extends ContentProvider {
    ...
    private static final String[] MMS_SMS_COLUMNS =
            { BaseColumns._ID, Mms.DATE, Mms.DATE_SENT, Mms.READ, Mms.THREAD_ID,
              Mms.LOCKED, Mms.SUB_ID,"favourite" };
    ...
    private static final String[] SMS_ONLY_COLUMNS =
            { "address", "body", "person", "reply_path_present",
              "service_center", "status", "subject", "type", "error_code", "rcs_path", "rcs_thumb_path", "is_rcs",
            ...
            "rcs_burn_body","rcs_message_id","date" ,"rcs_nmsg_state"};
    ...
    private static final String SMS_PROJECTION = "'sms' AS transport_type, _id, thread_id,"
            ...
            + "rcs_message_id,"
            + "rcs_chat_type,"
	        + " sub_id, date, date_sent, read, type,"
