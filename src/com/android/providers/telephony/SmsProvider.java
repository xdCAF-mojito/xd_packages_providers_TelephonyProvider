...
public class SmsProvider extends ContentProvider {
    ...
    public Cursor query(Uri url, String[] projectionIn, String selection,
        ...
        switch (match) {
            ...
            case SMS_INBOX_SIM1:
                constructQueryForBox(qb, Sms.MESSAGE_TYPE_INBOX_SIM1);
                break;

            case SMS_INBOX_SIM2:
                constructQueryForBox(qb, Sms.MESSAGE_TYPE_INBOX_SIM2);
                break;
    ...
    public Uri insert(Uri url, ContentValues initialValues) {
        ...
        switch (match) {
            ...
            case SMS_INBOX_SIM1:
                type = Sms.MESSAGE_TYPE_INBOX_SIM1;
                break;

            case SMS_INBOX_SIM2:
                type = Sms.MESSAGE_TYPE_INBOX_SIM2;
                break;
